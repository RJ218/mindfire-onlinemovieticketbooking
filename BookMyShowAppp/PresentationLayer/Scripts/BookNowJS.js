...
$.ajax(
       {
           ...
           success: (response) => {
               ...
               for (var i = 0; i < response.length; i++) {
                   ...
                   var movieprice=br.Price;
                   var str3 = br.ShowId;
                   console.log(br.Price);
                   ...
                   str1 = br.DateTime;
                   document.getElementById(str2).innerHTML += "<div class='cityLink card ml-2 col-md-auto' id='" + str + "' value='" + str2 + "' name='" + str3 + "'>" + str1 + "</div>";
               } console.log(movieprice);
               localStorage.setItem('movieprice', movieprice);
               //localStorge.getItem('movieprice');
               $(document).ready(function () {
                   $(".cityLink").click(function () {
                      ...
                      // var moviecost = $(this).attr("data");
                       console.log(showId);
                       console.log(theatreId);
                     //  localStorage.setItem('movieprice', moviecost);
                       localStorage.setItem("theatreid", theatreId);
                       localStorage.setItem("showid", showId);
                       localStorage.setItem("theatrenm", theatrename);
                       console.log(theatrename);
                       localStorage.setItem("time", time);
                      // console.log(localStorage.getItem("movieprice"));
